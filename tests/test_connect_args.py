...
def test_connect_args():
    ...
    conn.set_option(TSDB_OPTION_CONNECTIONS.TSDB_OPTION_CONNECTION_CHARSET.value, "utf8")
    conn.set_option(TSDB_OPTION_CONNECTIONS.TSDB_OPTION_CONNECTION_TIMEZONE.value, "UTC")
    conn.set_option(TSDB_OPTION_CONNECTIONS.TSDB_OPTION_CONNECTION_USER_IP.value, "127.0.0.2")
    conn.set_option(TSDB_OPTION_CONNECTIONS.TSDB_OPTION_CONNECTION_USER_APP.value, "python client")
