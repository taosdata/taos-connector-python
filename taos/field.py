...
def _crow_timestamp_to_python(
    ...
    return [
        None if is_null[i] else _timestamp_converter(ele) for i,
        ele in enumerate(
            ctypes.cast(
                data,
                ctypes.POINTER(
...
def _crow_bool_to_python(
    ...
    """Function to convert C bool row to python row"""
    return [
        None if is_null[i] else bool(ele) for i,
        ele in enumerate(
            ctypes.cast(
                data,
                ctypes.POINTER(
...
def _crow_tinyint_to_python(
    ...
    return [
        None if is_null[i] else ele for i,
        ele in enumerate(
            ctypes.cast(
                data,
                ctypes.POINTER(
...
def _crow_float_to_python(
    ...
    return [
        None if math.isnan(ele) else ele for i,
        ele in enumerate(
            ctypes.cast(
                data,
                ctypes.POINTER(
...
def _crow_nchar_to_python_block(
        data,
        is_null,
        num_of_rows,
        nbytes=None,
