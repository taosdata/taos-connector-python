...
def connect(**kwargs) -> TaosRestConnection:
   ...
   - timezone: str, optional, default None.
        ...
        If None, system timezone will be used and the returned datetime object will be offset-naive (no tzinfo), otherwise the returned datetime will be offset-aware(with tzinfo)
   Examples
   -----------------------------
